...
const Reservation = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-r from-red-500 to-black text-white">
      <div className="max-w-4xl mx-auto p-6 sm:p-8 bg-white rounded-lg shadow-2xl text-gray-900">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-900 bg-gradient-to-r from-red-500 via-black to-black text-transparent bg-clip-text mt-4 mb-6">
          Make a Reservation
        </h1>
        ...
        <div className="relative w-full mb-8">
          ...
          <motion.div
            className="absolute top-0 left-0 h-1 bg-gradient-to-r from-red-600 to-black"
            initial={{ width: "0%" }}
